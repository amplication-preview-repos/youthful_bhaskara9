...
@InputType()
class DonationCreateNestedManyWithoutSupportersInput {
...
export { DonationCreateNestedManyWithoutSupportersInput as DonationCreateNestedManyWithoutSupportersInput };
